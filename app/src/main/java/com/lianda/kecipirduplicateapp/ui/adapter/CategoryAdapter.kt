...
class CategoryAdapter(val context:Context, val datas:List<Category>, val onCategoryClicked:((category:String)->Unit)? = null) :RecyclerView.Adapter<CategoryAdapter.CategoryViewHolder>(){
